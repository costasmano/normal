...
If (False:C215)
	Mods_2005_CM06
	// Modified by: costasmanousakis-(Designer)-(10/12/2005 12:59:23)
	Mods_2005_CM17
	// Modified by: costasmanousakis-(Designer)-(5/22/2007 15:44:06)
	Mods_2007_CM10
	// Modified by: costasmanousakis-(Designer)-(12/17/07 09:54:40)
	Mods_2007_CM_5401
...
//Data consistency check for Routine or Arch inspection
...
End if 
If ([Inspections:27]Insp Type:6="RTN")
	If ([Inspections:27]Item 107:141#"N")
		If (([Inspections:27]Item 58:79="") | ([Inspections:27]Item 58:79="N"))
			$msgs:=$msgs+"Item 58 not completed!"+<>sCR
		End if 
	End if 
Else 
	//Arches can have no Deck - allow N rating for 58  
	If ([Inspections:27]Item 58:79="")
		$msgs:=$msgs+"Item 58 not completed!"+<>sCR
	End if 
End if 
If (([Inspections:27]Item 59:80="") | ([Inspections:27]Item 59:80="N"))
	$msgs:=$msgs+"Item 59 not completed!"+<>sCR
End if 
...
If ((([Inspections:27]CollisionDamSup:13#"N") & ([Inspections:27]CollisionDamSup:13#"")) & ([Inspections:27]CollisionSuper:98=""))
	$msgs:=$msgs+"There is Collision Damage in SuperStructure but there is no explanation!"+<>sCR
End if 
If ((([Inspections:27]LoadDeflection:14#"N") & ([Inspections:27]LoadDeflection:14#"R") & ([Inspections:27]LoadDeflection:14#"")) & ([Inspections:27]LoadDeflSuper:99=""))
	$msgs:=$msgs+"There is Excessive Load Deflection in SuperStructure but there is no explanation"+<>sCR
End if 
If ((([Inspections:27]LoadVibration:15#"N") & ([Inspections:27]LoadVibration:15#"R") & ([Inspections:27]LoadVibration:15#"")) & ([Inspections:27]LoadVibSuper:100=""))
	$msgs:=$msgs+"There is Excessive Load Vibration in SuperStructure but there is no explanation!"+<>sCR
End if 
If ((([Inspections:27]CollisionDamSub:18#"N") & ([Inspections:27]CollisionDamSub:18#"")) & ([Inspections:27]CollisionSub:101=""))
	$msgs:=$msgs+"There is Collision Damage in SubStructure but there is no explanation!"+<>sCR
End if 
If ((([Inspections:27]Scour:20#"N") & ([Inspections:27]Scour:20#"")) & ([Inspections:27]ScourTxt:103=""))
	$msgs:=$msgs+"There is Scour in SubStructure but there is no explanation!"+<>sCR
End if 
