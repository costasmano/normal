...
If (False:C215)
	...
	//User (4D) : Designer
	//Date and time: 12/20/17, 17:10:08
	// ----------------------------------------------------
	//Created : 
	Mods_2017_12
...
$Elem_txt:=DOM Find XML element:C864($NTI_DEFECT_ELEM_TREE; "NTI_ELEMDEFECTS/Element"; $Elements_atxt)
...
For ($loop_L; 1; Size of array:C274($Elements_atxt))
	...
	If ((Ok=0) | $UseDB_b)
		...
		$ElemName_txt:=[NTI_ELEM_DEFS:182]ELEM_LONGNAME:5
	End if 
	QUERY:C277([NTI_ELEM_DEFS:182]; [NTI_ELEM_DEFS:182]ELEM_KEY:4=$ElemVal_L)
	$ElemUnits_txt:=[NTI_ELEM_DEFS:182]ELEM_SCALEUNIT:12
	...
	For ($loop2_L; 1; Size of array:C274($ElemDefects_atxt))
		...
		If ((Ok=0) | $UseDB_b)
			QUERY:C277([NTI_ELEM_DEFS:182]; [NTI_ELEM_DEFS:182]ELEM_KEY:4=$DefectVal_L)
			$DefectName_txt:=[NTI_ELEM_DEFS:182]ELEM_LONGNAME:5
		End if 
		...
		Else 
			$ReportData_txt:=$ReportData_txt+String:C10($ElemVal_L)+Char:C90(Tab:K15:37)+String:C10($DefectVal_L)+Char:C90(Tab:K15:37)+\
				[NTI_ELEM_DEFS:182]ELEM_LONGNAME:5+Char:C90(Tab:K15:37)+\
...
$OutputFile_txt:=Select document:C905("ExportFile"; ".txt"; "Select Export document"; File name entry:K24:17)
