...
C_TEXT:C284($elemRef_txt; $ValueLst_txt)
...
For ($loop_L; 1; $NumRows_L)
	...
	DOM GET XML ATTRIBUTE BY NAME:C728($elemRef_txt; $HiLimAttrName_txt; $ValueLst_txt)
	If (Position:C15($SearchVal_txt; $ValueLst_txt)>0)
