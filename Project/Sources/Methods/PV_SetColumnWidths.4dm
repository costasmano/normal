...
If (False:C215)
	// Project Method: PV_SetColumnWidths (->area; col1 width; {col2 width...})
...
//C_LONGINT(${2};$columns;$width;$totalWidth;$column;$areaWidth)
...
//$totalWidth:=$totalWidth+${$column+1}
//End for 
...
//Else 
//$width:=$areaWidth*(${$column+1}/100)
//$totalWidth:=$totalWidth+$width
//End if 
//: (${$column+1}=-1)  // This is our variable column in a fixed width world.
