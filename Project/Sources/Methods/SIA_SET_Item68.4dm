...
If (False:C215)
	...
	// Date and time: 10/05/11, 17:13:05
	// ----------------------------------------------------
	// Method: SIA_SET_Item68
	// Description
	// 
	// 
	// Parameters
...
C_TEXT:C284($Item5c; $1; $Item26; $2; $Item41; $5; $Item75a; $9; $Item102; $10; $itm43_txt; $11)
C_LONGINT:C283($Item28a; $3)  //Command Replaced was o_C_INTEGER
C_LONGINT:C283($Item29; $4)
C_REAL:C285($Item49; $6; $Item51; $7; $Item53; $8)
...
If ((Substring:C12($itm43_txt; 2; 2)="19") & ($Item51=0))
	$value:="N"
End if 
// *** end of Change #7  
