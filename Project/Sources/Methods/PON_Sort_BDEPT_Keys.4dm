...
If (False:C215)
	...
	//User (4D) : Designer
	//Date and time: 08/22/17, 17:37:40
	// ----------------------------------------------------
	//Created : 
	Mods_2017_08
...
Else 
	$SortOrder_txt:=">"
End if 
//QUERY([Bridge MHD NBIS];[Bridge MHD NBIS]BIN=[PON_ELEM_INSP]BRKEY)
$SortValue_txt:=[Bridge MHD NBIS:1]BDEPT:1
