...
If (False:C215)
	...
	//User (4D) : Designer
	//Date and time: 05/29/14, 12:12:43
	// ----------------------------------------------------
	//Created : 
	Mods_2014_05
End if 
...
$LatLonFld_b:=($Fld_L=Field:C253(->[NBIS Secondary:3]Item16A:12)) | ($Fld_L=Field:C253(->[NBIS Secondary:3]Item16B:13)) | ($Fld_L=Field:C253(->[NBIS Secondary:3]Item16C:35))
$LatLonFld_b:=$LatLonFld_b | ($Fld_L=Field:C253(->[NBIS Secondary:3]Item17A:14)) | ($Fld_L=Field:C253(->[NBIS Secondary:3]Item17B:15)) | ($Fld_L=Field:C253(->[NBIS Secondary:3]Item17C:36))

If ($tbl_L=Table:C252(->[NBIS Secondary:3])) & $LatLonFld_b
				...
				If ($Degrees_R>0)
					Case of 
						: ($Degrees_R>41.2) & ($Degrees_R<42.9)
							//lat
							$DoCopy_b:=True:C214
							$degFld_ptr:=->[NBIS Secondary:3]Item16A:12
							$minFld_ptr:=->[NBIS Secondary:3]Item16B:13
							$secFld_ptr:=->[NBIS Secondary:3]Item16C:35
							
						: ($Degrees_R>69.93) & ($Degrees_R<73.51)
							$DoCopy_b:=True:C214
							$degFld_ptr:=->[NBIS Secondary:3]Item17A:14
							$minFld_ptr:=->[NBIS Secondary:3]Item17B:15
							$secFld_ptr:=->[NBIS Secondary:3]Item17C:36
							//lon -not here
					End case 
					If ($DoCopy_b)
