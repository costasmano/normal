...
If (False:C215)
	...
	//User (4D) : Designer
	//Date and time: 03/09/17, 16:35:15
	// ----------------------------------------------------
	//Created : 
	Mods_2017_03
	...
	If (Ok=1)
		...
		For ($i; 1; $Recs)
			...
			Else 
				$Item112:="N"
			End if 
			$Item113:=Change string:C234((" "*1); [BridgeMHDNBISArchive:139]Item113:150; 1)
			If ($Item113="D")
				$Item113:="6"
			End if 
			...
			End if 
			$t:="251"+$item8_txt
			$t:=$t+Change string:C234((" "*9); [BridgeMHDNBISArchive:139]Item5:58; 1)
			$t:=$t+[BridgeMHDNBISArchive:139]Item2:59  //2 , 3 , 4 are always filled correctly
			$t:=$t+[BridgeMHDNBISArchive:139]Item3:60
			$t:=$t+[BridgeMHDNBISArchive:139]Item4:61+$Item6A+$Item6B+$Item7
			$t:=$t+$Item9+$Item10+$Item11+$Item12+$Item13
			$t:=$t+$Item16+$Item17+$Item19
			$t:=$t+Change string:C234((" "*1); [BridgeMHDNBISArchive:139]Item20:125; 1)
			$t:=$t+Change string:C234((" "*2); [BridgeMHDNBISArchive:139]Item21:126; 1)
			$t:=$t+Change string:C234((" "*2); [BridgeMHDNBISArchive:139]Item22:127; 1)
			$t:=$t+Change string:C234((" "*2); [BridgeMHDNBISArchive:139]Item26:119; 1)
			$t:=$t+$Item27+$Item28+$Item29+$Item30+Change string:C234((" "*1); SIA_DesignLoadTrans([BridgeMHDNBISArchive:139]Item31:134); 1)+$Item32
			$t:=$t+Change string:C234((" "*1); [BridgeMHDNBISArchive:139]Item33:98; 1)
			$t:=$t+$Item34+$Item35
			$t:=$t+Change string:C234((" "*1); [BridgeMHDNBISArchive:139]Item36A:146; 1)
			$t:=$t+Change string:C234((" "*1); [BridgeMHDNBISArchive:139]Item36B:147; 1)
			$t:=$t+Change string:C234((" "*1); [BridgeMHDNBISArchive:139]Item36C:148; 1)
			$t:=$t+Change string:C234((" "*1); [BridgeMHDNBISArchive:139]Item36D:149; 1)
			$t:=$t+$Item37
			$t:=$t+Change string:C234((" "*1); [BridgeMHDNBISArchive:139]Item38:112; 1)
			$t:=$t+$Item39+$Item40
			$t:=$t+Change string:C234((" "*1); [BridgeMHDNBISArchive:139]Item41:140; 1)
			$t:=$t+Change string:C234((" "*2); [BridgeMHDNBISArchive:139]Item42:84; 1)
			$t:=$t+Change string:C234((" "*3); [BridgeMHDNBISArchive:139]Item43:74; 1)
			...
			$t:=$t+Change string:C234((" "*1); [BridgeMHDNBISArchive:139]Item58:129; 1)
			$t:=$t+Change string:C234((" "*1); [BridgeMHDNBISArchive:139]Item59:130; 1)
			$t:=$t+Change string:C234((" "*1); [BridgeMHDNBISArchive:139]Item60:131; 1)
			$t:=$t+Change string:C234((" "*1); [BridgeMHDNBISArchive:139]Item61:132; 1)
			$t:=$t+Change string:C234((" "*1); [BridgeMHDNBISArchive:139]Item62:133; 1)
			$t:=$t+$Item63+$Item64
			$t:=$t+$Item65+$Item66
			$t:=$t+[BridgeMHDNBISArchive:139]Item67:141  //67 68 69 70 are also calculated
			$t:=$t+[BridgeMHDNBISArchive:139]Item68:142
			$t:=$t+[BridgeMHDNBISArchive:139]Item69:143
			$t:=$t+[BridgeMHDNBISArchive:139]Item70:139
			$t:=$t+Change string:C234((" "*1); [BridgeMHDNBISArchive:139]Item71:144; 1)
			$t:=$t+Change string:C234((" "*1); [BridgeMHDNBISArchive:139]Item72:145; 1)
			$t:=$t+$Item75+$Item76+$Item90+$Item91+$Item92+$Item93A+$Item93B+$Item93C
			$t:=$t+$Item94+$Item95+$Item96+$Item97
			$t:=$t+Change string:C234((" "*3); [BridgeMHDNBISArchive:139]Item98A:71; 1)
			$t:=$t+Change string:C234((" "*2); [BridgeMHDNBISArchive:139]Item98B:72; 1)
			$t:=$t+Change string:C234((" "*15); [BridgeMHDNBISArchive:139]Item99:73; 1)
			$t:=$t+Change string:C234((" "*1); [BridgeMHDNBISArchive:139]Item100:120; 1)
			$t:=$t+Change string:C234((" "*1); [BridgeMHDNBISArchive:139]Item101:121; 1)
			$t:=$t+Change string:C234((" "*1); [BridgeMHDNBISArchive:139]Item102:122; 1)
			$t:=$t+$Item103+$Item104+$Item105
			$t:=$t+$Item106
			$t:=$t+Change string:C234((" "*1); [BridgeMHDNBISArchive:139]Item107:78; 1)
			$t:=$t+Change string:C234((" "*1); [BridgeMHDNBISArchive:139]Item108A:79; 1)
			$t:=$t+Change string:C234((" "*1); [BridgeMHDNBISArchive:139]Item108B:80; 1)
			$t:=$t+Change string:C234((" "*1); [BridgeMHDNBISArchive:139]Item108C:81; 1)
			...
			If (True:C214)  //Includes CR and LF
				...
				$et:=""
				$errprefix_txt:=[BridgeMHDNBISArchive:139]InspResp:172+Char:C90(9)+[BridgeMHDNBISArchive:139]BIN:3+Char:C90(9)+[BridgeMHDNBISArchive:139]Item5:58+Char:C90(9)
				If (Length:C16([BridgeMHDNBISArchive:139]Item5:58)<9)
					$et:=$et+$errPrefix_txt+"5"+Char:C90(9)+"Length"+Char:C90(9)+" < 9 : -"+[BridgeMHDNBISArchive:139]Item5:58+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16($Item9)<25)
					$et:=$et+$errPrefix_txt+"9"+Char:C90(9)+"Length"+Char:C90(9)+": blank : -"+[BridgeMHDNBISArchive:139]Item9:65+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item20:125)<1)
					$et:=$et+$errPrefix_txt+"20"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[BridgeMHDNBISArchive:139]Item20:125+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item21:126)<2)
					$et:=$et+$errPrefix_txt+"21"+Char:C90(9)+"Length"+Char:C90(9)+" < 2 : -"+[BridgeMHDNBISArchive:139]Item21:126+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item22:127)<2)
					$et:=$et+$errPrefix_txt+"22"+Char:C90(9)+"Length"+Char:C90(9)+" < 2 : -"+[BridgeMHDNBISArchive:139]Item22:127+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item26:119)<2)
					$et:=$et+$errPrefix_txt+"26"+Char:C90(9)+"Length"+Char:C90(9)+" < 2 : -"+[BridgeMHDNBISArchive:139]Item26:119+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item31:134)<1)
					$et:=$et+$errPrefix_txt+"31"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[BridgeMHDNBISArchive:139]Item31:134+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item33:98)<1)
					$et:=$et+$errPrefix_txt+"33"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[BridgeMHDNBISArchive:139]Item33:98+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item36A:146)<1)
					$et:=$et+$errPrefix_txt+"36A"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[BridgeMHDNBISArchive:139]Item36A:146+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item36B:147)<1)
					$et:=$et+$errPrefix_txt+"36B"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[BridgeMHDNBISArchive:139]Item36B:147+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item36C:148)<1)
					$et:=$et+$errPrefix_txt+"36C"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[BridgeMHDNBISArchive:139]Item36C:148+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item36D:149)<1)
					$et:=$et+$errPrefix_txt+"36D"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[BridgeMHDNBISArchive:139]Item36D:149+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item38:112)<1)
					$et:=$et+$errPrefix_txt+"38"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[BridgeMHDNBISArchive:139]Item38:112+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item41:140)<1)
					$et:=$et+$errPrefix_txt+"41"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[BridgeMHDNBISArchive:139]Item41:140+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item42:84)<2)
					$et:=$et+$errPrefix_txt+"42"+Char:C90(9)+"Length"+Char:C90(9)+" < 2 : -"+[BridgeMHDNBISArchive:139]Item42:84+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item43:74)<3)
					$et:=$et+$errPrefix_txt+"43"+Char:C90(9)+"Length"+Char:C90(9)+" < 3 : -"+[BridgeMHDNBISArchive:139]Item43:74+"-"+<>sCR+<>sLF
				End if 
				...
				If (Length:C16([BridgeMHDNBISArchive:139]Item58:129)<1)
					$et:=$et+$errPrefix_txt+"58"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[BridgeMHDNBISArchive:139]Item58:129+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item59:130)<1)
					$et:=$et+$errPrefix_txt+"59"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[BridgeMHDNBISArchive:139]Item59:130+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item60:131)<1)
					$et:=$et+$errPrefix_txt+"60"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[BridgeMHDNBISArchive:139]Item60:131+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item61:132)<1)
					$et:=$et+$errPrefix_txt+"61"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[BridgeMHDNBISArchive:139]Item61:132+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item62:133)<1)
					$et:=$et+$errPrefix_txt+"62"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[BridgeMHDNBISArchive:139]Item62:133+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item71:144)<1)
					$et:=$et+$errPrefix_txt+"71"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[BridgeMHDNBISArchive:139]Item71:144+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item72:145)<1)
					$et:=$et+$errPrefix_txt+"72"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[BridgeMHDNBISArchive:139]Item72:145+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item98A:71)<3)
					$et:=$et+$errPrefix_txt+"98A"+Char:C90(9)+"Length"+Char:C90(9)+" < 3 : -"+[BridgeMHDNBISArchive:139]Item98A:71+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item98B:72)<2)
					$et:=$et+$errPrefix_txt+"98b"+Char:C90(9)+"Length"+Char:C90(9)+" < 2 : -"+[BridgeMHDNBISArchive:139]Item98B:72+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item99:73)<15)
					$et:=$et+$errPrefix_txt+"99"+Char:C90(9)+"Length"+Char:C90(9)+" < 15 : -"+[BridgeMHDNBISArchive:139]Item99:73+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item100:120)<1)
					$et:=$et+$errPrefix_txt+"100"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[BridgeMHDNBISArchive:139]Item100:120+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item101:121)<1)
					$et:=$et+$errPrefix_txt+"101"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[BridgeMHDNBISArchive:139]Item101:121+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item102:122)<1)
					$et:=$et+$errPrefix_txt+"102"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[BridgeMHDNBISArchive:139]Item102:122+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item107:78)<1)
					$et:=$et+$errPrefix_txt+"107"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[BridgeMHDNBISArchive:139]Item107:78+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item108A:79)<1)
					$et:=$et+$errPrefix_txt+"108A"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[BridgeMHDNBISArchive:139]Item108A:79+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item108B:80)<1)
					$et:=$et+$errPrefix_txt+"108B"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[BridgeMHDNBISArchive:139]Item108B:80+"-"+<>sCR+<>sLF
				End if 
				If (Length:C16([BridgeMHDNBISArchive:139]Item108C:81)<1)
					$et:=$et+$errPrefix_txt+"108C"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[BridgeMHDNBISArchive:139]Item108C:81+"-"+<>sCR+<>sLF
				End if 
			...
			For ($j; 1; Records in selection:C76([NBISSecondaryArchive:140]))
				...
				$t:="251"+$item8_txt+[NBISSecondaryArchive:140]Item5:4+(" "*2)  //item 5 should always be OK 
				$t:=$t+[NBISSecondaryArchive:140]Item3:2+[NBISSecondaryArchive:140]Item4:3+$Item6A+$Item6B+$Item7  // 3 and 4 are always OK
				$t:=$t+$Item9+$Item10+$Item11+(" "*13)
				$t:=$t+$Item16+$Item17+$Item19+Change string:C234((" "*1); [NBISSecondaryArchive:140]Item20:17; 1)+(" "*4)
				$t:=$t+Change string:C234((" "*2); [NBISSecondaryArchive:140]Item26:18; 1)+$Item27+$Item28+$Item29+$Item30+(" "*5)
				$t:=$t+(" "*8)
				$t:=$t+(" "*12)+Change string:C234((" "*2); [NBISSecondaryArchive:140]Item42:23; 1)
				$t:=$t+Change string:C234((" "*3); [NBISSecondaryArchive:140]Item43:24; 1)+(" "*10)+$Item47+$Item48+$Item49
				$t:=$t+(" "*127)
				$t:=$t+Change string:C234((" "*1); [NBISSecondaryArchive:140]Item100:28; 1)+Change string:C234((" "*1); [NBISSecondaryArchive:140]Item101:29; 1)+Change string:C234((" "*1); [NBISSecondaryArchive:140]Item102:30; 1)+$Item103+$Item104
				$t:=$t+(" "*9)
				...
				If (True:C214)  //Includes CR and LF
					...
					$et:=""
					$errprefix_txt:=[BridgeMHDNBISArchive:139]InspResp:172+Char:C90(9)+[BridgeMHDNBISArchive:139]BIN:3+Char:C90(9)+[NBISSecondaryArchive:140]Item5:4+Char:C90(9)
					If (Length:C16([NBISSecondaryArchive:140]Item20:17)<1)
						$et:=$et+$errPrefix_txt+"20"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[NBISSecondaryArchive:140]Item20:17+"-"+<>sCR+<>sLF
					End if 
					If (Length:C16([NBISSecondaryArchive:140]Item26:18)<2)
						$et:=$et+$errPrefix_txt+"26"+Char:C90(9)+"Length"+Char:C90(9)+" < 2 : -"+[NBISSecondaryArchive:140]Item26:18+"-"+<>sCR+<>sLF
					End if 
					If (Length:C16([NBISSecondaryArchive:140]Item42:23)<2)
						$et:=$et+$errPrefix_txt+"42"+Char:C90(9)+"Length"+Char:C90(9)+" < 2 : -"+[NBISSecondaryArchive:140]Item42:23+"-"+<>sCR+<>sLF
					End if 
					If (Length:C16([NBISSecondaryArchive:140]Item43:24)<3)
						$et:=$et+$errPrefix_txt+"43"+Char:C90(9)+"Length"+Char:C90(9)+" < 3 : -"+[NBISSecondaryArchive:140]Item43:24+"-"+<>sCR+<>sLF
					End if 
					If (Length:C16([NBISSecondaryArchive:140]Item100:28)<1)
						$et:=$et+$errPrefix_txt+"100"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[NBISSecondaryArchive:140]Item100:28+"-"+<>sCR+<>sLF
					End if 
					If (Length:C16([NBISSecondaryArchive:140]Item101:29)<1)
						$et:=$et+$errPrefix_txt+"101"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[NBISSecondaryArchive:140]Item101:29+"-"+<>sCR+<>sLF
					End if 
					If (Length:C16([NBISSecondaryArchive:140]Item102:30)<1)
						$et:=$et+$errPrefix_txt+"102"+Char:C90(9)+"Length"+Char:C90(9)+" < 1 : -"+[NBISSecondaryArchive:140]Item102:30+"-"+<>sCR+<>sLF
					End if 
					If ($et#"")
						If (Not:C34($errHeader_b))
							//SEND PACKET($dErrFile;("Item Length Errors found for BIN : "+[BridgeMHDNBISArchive]BIN+◊sCR+◊sLF))
