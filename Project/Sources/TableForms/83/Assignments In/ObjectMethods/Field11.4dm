If (False:C215)
	...
	C_REAL:C285($temp)
	$temp:=Round:C94([Contract Assignments:83]Est_IndirectCost:11/([Contracts:79]OverheadRate:10/100); 2)
	If (Dec:C9($temp)=0.99)
	...
	$temp:=Round:C94([Contract Assignments:83]Est_Salary:10*([Contracts:79]OverheadRate:10/100+1)*([Contracts:79]NetFeeRate:11/100); 2)
	If (Dec:C9($temp)=0.99)
