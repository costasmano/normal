//[PRJ_ProjectDetails];"ProjectDetails_LB".PRJ_QRDescriptions_atxt  
// ----------------------------------------------------
...
If (False:C215)
	...
	// Modified by: Costas Manousakis-(Designer)-(2022-06-08 19:45:45)
	Mods_2022_06
			...
			Else 
				...
				If (PRJ_QuickReports_atxt{PRJ_QRDescriptions_atxt}="QRT_@")
					...
					Case of 
						...
						: (Records in selection:C76([Templates:86])>1)
							ALERT:C41("Multiple Quick report templates found for name "+PRJ_QuickReports_atxt{PRJ_QRDescriptions_atxt}+" !")
					End case 
