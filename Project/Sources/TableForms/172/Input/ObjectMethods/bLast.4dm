...
//Date and time: 11/20/14, 15:58:29
//----------------------------------------------------
//Method: Object Method: [LSS_SignPanel].Input.bLast
//Description
//
// Parameters
// ----------------------------------------------------
...
Case of 
	...
	: (Form event code:C388=On Clicked:K2:4)
		...
		LSS_SelectedRow_L:=Records in selection:C76([LSS_SignPanel:172])
...
End case 
//End Object Method: [LSS_SignPanel].Input.bLast
