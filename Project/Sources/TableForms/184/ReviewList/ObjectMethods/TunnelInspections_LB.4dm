If (False:C215)
	//[TIN_Inspections];"ReviewList".TunnelInspections_LB 
	// Modified by: Costas Manousakis-(Designer)-(2023-09-20 13:47:20)
	Mods_2023_09
		...
		: (Form event code:C388=On Header Click:K2:40)
			...
			Case of 
				...
				: ($nameofObj_txt="Header7")
					If (Self:C308->>1)
						ORDER BY:C49([TIN_Inspections:184]; [NTI_TunnelInfo:181]NTI_i10_s:15; >)
						COPY NAMED SELECTION:C331([TIN_Inspections:184]; "NTI_TunnelInspSet")
						Header7:=1
					Else 
						ORDER BY:C49([TIN_Inspections:184]; [NTI_TunnelInfo:181]NTI_i10_s:15; <)
						...
						Header7:=2
					End if 
				: ($nameofObj_txt="Header8")
					If (Self:C308->>1)
						ORDER BY:C49([TIN_Inspections:184]; [NTI_TunnelInfo:181]NTI_i2_s:7; >)
						COPY NAMED SELECTION:C331([TIN_Inspections:184]; "NTI_TunnelInspSet")
						Header8:=1
					Else 
						ORDER BY:C49([TIN_Inspections:184]; [NTI_TunnelInfo:181]NTI_i2_s:7; <)
		...
		: (Form event code:C388=On Clicked:K2:4)
			...
			If ($LBRow_L>0)
				If (Contextual click:C713)
					...
					<>INSP_DBIE_b:=($DBIEPriv_b | User in group:C338(<>CURRENTUSER_NAME; "Design Access Group"))
					<>INSP_AreaEng_b:=($AreaPRIV_b | User in group:C338(<>CURRENTUSER_NAME; "Design Access Group"))
					$PopUpMenu_txt:="( ;Edit;Print;"  //Review;Duplicate"
					If (($DBIEReq_b & $DBIEPriv_b) | User in group:C338(<>CURRENTUSER_NAME; "Design Access Group"))
						$PopUpMenu_txt:=$PopUpMenu_txt+"D.T.I.E. Review;"
					End if 
					If (($AreaReq_b & $AreaPRIV_b) | User in group:C338(<>CURRENTUSER_NAME; "Design Access Group"))
