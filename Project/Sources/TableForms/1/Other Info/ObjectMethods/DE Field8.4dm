If (False:C215)
	...
	Mods_2004_CM12
	// Modified by: costasmanousakis-(Designer)-(12/30/09 11:20:06)
	Mods_2009_12
	//  `When switching to NBI - change the state of [Bridge MHD NBIS]InspRequired accordingly
...
If (Form event code:C388=On Clicked:K2:4)
	...
	End if 
	If (Self:C308->)
		If ([Bridge MHD NBIS:1]InspRequired:227)
			[Bridge MHD NBIS:1]InspRequired:227:=False:C215
			PushChange(1; ->[Bridge MHD NBIS:1]InspRequired:227)
		End if 
		OBJECT SET ENTERABLE:C238([Bridge MHD NBIS:1]InspRequired:227; False:C215)
		
	Else 
		OBJECT SET ENTERABLE:C238([Bridge MHD NBIS:1]InspRequired:227; True:C214)
	End if 
End if 