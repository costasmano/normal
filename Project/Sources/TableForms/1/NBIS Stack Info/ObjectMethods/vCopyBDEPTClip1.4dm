...
ARRAY TEXT:C222($arr_BDept_S; 0)  //Command Replaced was o_ARRAY string length was 6
If (Records in set:C195("UserSet")>0)
	COPY NAMED SELECTION:C331(Current form table:C627->; "ListPreCmdCopy")
	USE SET:C118("UserSet")
	SELECTION TO ARRAY:C260([Bridge MHD NBIS:1]BDEPT:1; $arr_BDept_S)
...
$numbins:=Size of array:C274($arr_BDept_S)

If ($numbins>0)
	//ALERT("Copying BINS")
	CLEAR PASTEBOARD:C402
	C_BLOB:C604($ClipBlob)
	TEXT TO BLOB:C554($arr_BDept_S{1}; $ClipBlob; Mac text without length:K22:10; *)
	For ($i; 2; $numbins)
		TEXT TO BLOB:C554((","+$arr_BDept_S{$i}); $ClipBlob; Mac text without length:K22:10; *)
	End for 
	TEXT TO BLOB:C554(Char:C90(0); $ClipBlob; Mac text without length:K22:10; *)
	APPEND DATA TO PASTEBOARD:C403("TEXT"; $ClipBlob)
	If (OK=0)
		ALERT:C41("Unable to copy List of BDEPTs to ClipBoard")
	End if 
