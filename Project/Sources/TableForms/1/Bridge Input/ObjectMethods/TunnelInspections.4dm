...
//----------------------------------------------------
//Method: Object Method: [Bridge MHD NBIS].Bridge Input.TunnelInspections_LB 
//Description
//
// Parameters
// ----------------------------------------------------
If (False:C215)
	...
	// Modified by: Costas Manousakis-(Designer)-(3/18/21 16:40:13)
	Mods_2021_03
...
Case of 
	...
	: (Form event code:C388=On Clicked:K2:4)
		...
		If ($row_l>=1) & ($row_l<=Records in selection:C76([Combined Inspections:90]))
			...
			If (Records in set:C195("LBSetTunnelInsp")=1)
