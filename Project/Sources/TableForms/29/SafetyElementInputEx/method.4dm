If (False:C215)
	// Form Method: [ElementsSafety];"SafetyElementInputEx "
	
	// Modified by: costasmanousakis-(Designer)-(1/22/08 12:08:39)
	Mods_2007_CM_5401
	...
	// Modified by: Costas Manousakis-(Designer)-(4/15/14 17:37:52)
	Mods_2014_04
	//  `added fields for table [ElmtRatingLoads]
	// Modified by: Costas Manousakis-(Designer)-(4/20/21 18:14:07)
	Mods_2021_WP
	//  `
