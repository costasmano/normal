...
//Date and time: 04/02/15, 10:29:48
//----------------------------------------------------
//Method: Object Method: [LSS_UT].Input.bNext
//Description
//
// Parameters
// ----------------------------------------------------
If (False:C215)
	Mods_2014_Lighting  // 
	//Modified by: administrator (4/2/15 10:29:49)
	
End if 
Case of 
	: (Form event code:C388=On Load:K2:1)
		C_TEXT:C284($Tip_txt)
		$Tip_txt:="Next Ultrasonic Test (PgDn)"
...
End case 
//End Object Method: [LSS_UT].Input.bNext
