If (False:C215)
	...
	// Modified by: costasmanousakis-(Designer)-(3/5/10 14:21:28)
	Mods_2010_03
	//  `Changed to Form event
	//  `Added code to control entry /deletion buttons depending on whether user has read write access
	// Modified by: manousakisc-(Designer)-(9/7/2023 10:53:53)
	Mods_2023_09
...
Case of 
	: (Form event code:C388=On Load:K2:1)
		...
		Else 
			...
			OBJECT SET ENABLED:C1123(*; "DeleteButton"; False:C215)  // Command Replaced was o_DISABLE BUTTON 
