...
//Date and time: 01/07/16, 14:53:30
//----------------------------------------------------
//Method: Object Method: [LSS_Inventory].Edit_SIN.v_165_007_r
//Description
//
// Parameters
// ----------------------------------------------------
...
Case of 
	: (Form event code:C388=On Data Change:K2:15)
		If (v_165_007_r#0)
			[LSS_Inventory:165]LSS_KiloPoint_r:7:=v_165_007_r
	...
	: (Form event code:C388=On After Keystroke:K2:26)
		OBJECT SET ENABLED:C1123(*; "ApplyButton"; False:C215)  // Command Replaced was o_DISABLE BUTTON 
End case 
//End Object Method: [LSS_Inventory].Edit_SIN.v_165_007_r
