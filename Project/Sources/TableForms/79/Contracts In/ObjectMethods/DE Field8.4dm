...
[Contracts:79]InitContractSalary:13:=Round:C94([Contracts:79]InitContractTotalLimitFee:14/(([Contracts:79]OverheadRate:10/100+1)*([Contracts:79]NetFeeRate:11/100+1)); 2)
