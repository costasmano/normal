//known variable = total limiting fee
If (False:C215)
	[Contract_Maintenance:97]InitContractSalary:13:=Round:C94([Contract_Maintenance:97]InitContractTotalLimitFee:14/(([Contract_Maintenance:97]OverheadRate:10/100+1)*([Contract_Maintenance:97]NetFeeRate:11/100+1)); 2)
End if 
