...
Case of 
	: (Form event code:C388=On Load:K2:1)
		...
		DISTINCT VALUES:C339([Contract_Maintenance:97]ContractStatus:7; CM_SelByStatus)
	...
	: (Form event code:C388=On Clicked:K2:4)
		...
		If (CM_SelByStatus{CM_SelByStatus}#CM_SelByStatus{0})
			If ($pickedItm_L#1)
				QUERY:C277([Contract_Maintenance:97]; [Contract_Maintenance:97]ContractStatus:7=CM_SelByStatus{CM_SelByStatus})
			Else 
