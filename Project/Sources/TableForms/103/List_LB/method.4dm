		...
		If (Current user:C182="designer")
			Case of 
				: ([Work_Estimate:103]WkHrEstReviewed:33=0)
					LB_Detail5_pct:=LB_Detail5_pct*0
				: ([Work_Estimate:103]WkHrEstReviewed:33=1)
					GET PICTURE FROM LIBRARY:C565("BMS RejectIcon"; LB_Detail5_pct)
				: ([Work_Estimate:103]WkHrEstReviewed:33=2)
					GET PICTURE FROM LIBRARY:C565("BMS ApproveIcon"; LB_Detail5_pct)
					
			End case 
			Case of 
				: ([Work_Estimate:103]WkHrEstApproved:18=0)
					LB_Detail6_pct:=LB_Detail6_pct*0
				: ([Work_Estimate:103]WkHrEstApproved:18=1)
					GET PICTURE FROM LIBRARY:C565("BMS RejectIcon"; LB_Detail6_pct)
				: ([Work_Estimate:103]WkHrEstApproved:18=2)
					GET PICTURE FROM LIBRARY:C565("BMS ApproveIcon"; LB_Detail6_pct)
