...
If (CRTG_AutoCalc_L=0)
	...
	If ((netFeeRate#0) & (overheadRate#0))
		[Cons Inspection Cost:76]Act Salary:22:=[Cons Inspection Cost:76]Act IndirectCost:23/(overheadRate/100)
		[Cons Inspection Cost:76]Act NetFee:24:=([Conslt Rating Cost:74]Act Salary:21+[Conslt Rating Cost:74]Act IndirectCost:39)*netFeeRate/100
	End if 
