...
If (Not:C34(INSP_SelectbyRespNew_b)\
	...
	QUERY SELECTION:C341([Inspections:27]; [Bridge MHD NBIS:1]InspResp:173="@"\
		+\
		Substring:C12(InspRespDescSel_atxt{\
		InspRespDescSel_atxt}\
		; 6; 1)\
		)\
		
Else 
	QUERY SELECTION:C341([Inspections:27]; [Bridge MHD NBIS:1]InspResp:173=InspRespSelect_atxt{\
		InspRespDescSel_atxt}\
		)\
