If (False:C215)
	//procedure: [Inspections];"Dive Form"
	//by: Albert Leung
	//created: 
	//modified:
	//6/2001
	...
	//purpose: initialize variables for [Inspections];"Dive Form"
	...
	Mods_2006_CMy2
	// Modified by: Costas Manousakis-(Designer)-(5/9/12 17:15:48)
	Mods_2012_05
	//  `Renamed the format pulldowns and changed the code there to call  WRUTIL_Function
	// Modified by: Costas Manousakis-(Designer)-(1/16/15 14:23:04)
	Mods_2015_01
	//  `added fiield [Inspections]InspFldWorkComplDate
	// Modified by: Costas Manousakis-(Designer)-(5/29/18 17:09:42)
	Mods_2018_05
