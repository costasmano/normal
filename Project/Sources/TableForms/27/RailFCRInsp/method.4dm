If (False:C215)
	...
	Mods_2006_CM03
	// Modified by: costasmanousakis-(Designer)-(4/10/2007 11:31:31)
	Mods_2007_CM07
	...
	// Modified by: Kenny Yang-(Designer)-(4/24/14 13:58:13)
	Mods_2014_04
	//  `new form, with 5 rating loads per element
	// Modified by: Costas Manousakis-(Designer)-(6/5/15 12:29:28)
	Mods_2015_06
	//  `changed style sheet of vRemarksxx to Arial10Bold from Arial11Bold
	// Modified by: Costas Manousakis-(Designer)-(12/2/19 15:58:23)
	Mods_2019_12
