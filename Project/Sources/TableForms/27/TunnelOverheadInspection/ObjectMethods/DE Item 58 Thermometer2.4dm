...
End if 
[TunnelInspection:152]Ceiling_Rtg_s:5:=String:C10(tItem62c; "0")  //if the format is # and tItem58 is equal to 0 string returns a blank!
PushChange(5; ->[TunnelInspection:152]Ceiling_Rtg_s:5)
If (Self:C308-><5)
