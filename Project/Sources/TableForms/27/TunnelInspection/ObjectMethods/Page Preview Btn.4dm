If (False:C215)
	...
	//Object Method: [Inspections].TunnelInspection.vbPGPreview
	...
	// Modified by: Costas Manousakis-(Designer)-(8/11/14 13:27:43)
	Mods_2014_08
	//  `set vPageNo=2 befroe printing any spec memb pages. (was viCmtsPgStart-1)
	// Modified by: Costas Manousakis-(Designer)-(5/23/16 16:53:06)
	Mods_2016_NTE
	//  `use new NTI_Preview
...
Case of 
	...
	: ($pageName_txt="NTE")
		If (Records in selection:C76([NTI_ELEM_BIN_INSP:183])>0)
			NTI_Preview(->[NTI_ELEM_BIN_INSP:183])
		Else 
			ALERT:C41("There are no National Tunnel Elements!")
		End if 
