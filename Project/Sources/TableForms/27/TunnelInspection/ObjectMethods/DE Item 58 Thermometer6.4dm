...
End if 
[TunnelInspection:152]UtilityRoom_Rtg_s:9:=String:C10(tItem62g; "0")  //if the format is # and tItem58 is equal to 0 string returns a blank!
PushChange(5; ->[TunnelInspection:152]UtilityRoom_Rtg_s:9)
If (Self:C308-><5)
