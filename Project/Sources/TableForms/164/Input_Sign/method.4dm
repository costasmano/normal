...
//Date and time: 04/15/15, 15:34:11
//----------------------------------------------------
...
If (False:C215)
	Mods_2014_Lighting  // 
	//Modified by: administrator (4/15/15 15:34:12)
	Mods_2015_08_bug
	...
	// Modified by: Costas Manousakis-(Designer)-(2/24/16 13:08:50)
	Mods_2016_02_bug
...
If (Form event code:C388=On Load:K2:1)
	...
	LSS_SetInspInputFormHeight("Input_Sign")
	
End if 
FM_InspectionInput
//End Form Method: [LSS_Inspection]Input_Sign