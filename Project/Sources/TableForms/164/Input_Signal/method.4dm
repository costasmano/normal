...
//Date and time: 04/15/15, 15:35:34
//----------------------------------------------------
...
If (False:C215)
	Mods_2014_Lighting  // 
	//Modified by: administrator (4/15/15 15:35:34)
...
If (Form event code:C388=On Load:K2:1)
	...
	LSS_SetInspInputFormHeight("Input_Signal")
	
End if 
FM_InspectionInput
//End Form Method: [LSS_Inspection]Input_Signal
