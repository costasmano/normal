//Method: [NTI_TunnelRatings].Input.bLast
//Description
//
// Parameters
// ----------------------------------------------------
If (False:C215)
	...
	//User (4D) : Designer
	//Date and time: 05/02/18, 13:22:28
	// ----------------------------------------------------
	//Created : 
	Mods_2018_05
End if 
//
FM_SaveTunnelRating
LSS_SelectedRow_L:=Records in selection:C76([NTI_TunnelRatings:189])
...
//End [NTI_TunnelRatings].Input.bLast