...
End if 
//C_REAL($WRUnit_r)
//$WRUnit_r:=WR Get doc property (WriteArea;wr unit)
//WR SET DOC PROPERTY (WriteArea;wr unit;2)  //pixels - more precise, no rounding errors
//WRT_GetSetMargins (WriteArea;"GET")
...
//CLOSE WINDOW
//If (OK=1)
//WRT_GetSetMargins (WriteArea;"SET")
...
//End if 
//WR SET DOC PROPERTY (WriteArea;wr unit;$WRUnit_r)
