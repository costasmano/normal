...
If (False:C215)
	//Created : 
	Mods_2012_01
	// Modified by: Costas Manousakis-(Designer)-(2022-05-31 19:56:11)
	Mods_2022_05
...
Case of 
	: (Form event code:C388=On Load:K2:1)
		// MUST NAME THE BUTTON VARIABLE THE SAME AS LB_Reports
		...
		If ((LB_Reports>0) & (LB_Reports<=Size of array:C274(ButtonPopupCommands_atxt)))
			...
			Case of 
				...
				Else 
					...
					If (4D_ERROR_B)
						4D_ERROR_B:=False:C215
						ALERT:C41("Error executing menu command "+ButtonPopupCommands_atxt{LB_Reports}+Char:C90(Carriage return:K15:38)+\
