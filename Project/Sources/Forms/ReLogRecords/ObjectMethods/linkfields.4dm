//Method: ReLogRecords.linkfields
...
If (Is table number valid:C999($selectedTable))
	...
	If (Length:C16($saveData_ptr->)>0)
		...
		OB GET ARRAY:C1229($fields_o; "fieldstolink"; $Fields_aL)
	End if 
	
	Dev_pickFields(Table:C252(TableList_aL{$selectedTable}); ->$Fields_aL)
	
	OB SET ARRAY:C1227($fields_o; "fieldstolink"; $Fields_aL)
	...
	End for 
	OB SET ARRAY:C1227($fields_o; "fieldnamestolink"; $fieldnames_atxt)
