...
Case of 
	...
	: (Form event code:C388=On Load:K2:1)
		...
		End if 
	: (Form event code:C388=On Data Change:K2:15) | (Form event code:C388=On Getting Focus:K2:7)
		//OBJECT SET TITLE(*;"EndDateTitle";"Start Date :"+String($enddate_ptr->))
		If ($startdate_ptr->#!00-00-00!) & ($enddate_ptr->#!00-00-00!)
