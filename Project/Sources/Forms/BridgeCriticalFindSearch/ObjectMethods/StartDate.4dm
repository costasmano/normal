...
C_POINTER:C301($startdate_ptr; $endDate_ptr)
...
Case of 
	...
	: (Form event code:C388=On Load:K2:1)
		...
		DatePicker SET MAX DATE($FormName; Current date:C33)  //max date is current date 
		
	: (Form event code:C388=On Data Change:K2:15)
		If ($startdate_ptr->#!00-00-00!)
			OBJECT SET VISIBLE:C603(*; "Enddate"; True:C214)
			DatePicker SET MIN DATE("EndDate"; $startdate_ptr->)  //min date is start date 
			
			If ($endDate_ptr->#!00-00-00!)
				OBJECT SET ENABLED:C1123(*; "OKButton"; True:C214)
			End if 
			
		End if 
		//OBJECT SET TITLE(*;"StartDateTitle";"Start Date :"+String($startdate_ptr->))
End case 
